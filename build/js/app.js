...
$("#myRepos").html(" "); // We are getting the content in the id myRepos and setting the content to empty
  console.log(response);
   ...
   // A function calculating the length of the response and if  length is greater than 0 Github Respositories is appended
...
$("#myRepos").append("<div>" + "<h1><a href='" + this.url + "'><span class='title'></span> " + this.name + "</a></h1>" + "<div>" + "<p>Created: " + created + "</p>" + "<p>Updated: " + updated + "</p>" + "</div>" + "<div class='col-md-12'>" + "<p>" + description + "</p>" + "</div>" +  "</div>");
    })
$('.profile-picture').html('<img src="'+response[0].owner.avatar_url+'">'); // We are getting Github user profile picture
    }
     else {
